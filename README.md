# 修理导航站 (Repair Navigator)

修理导航站是一个多语言的修理相关资源导航网站，基于WebStack.cc的模板开发，提供了丰富的修理资源分类和链接。

## 特点

- **多语言支持**：支持英语、中文、德语、法语、西班牙语、日语和韩语
- **响应式设计**：适配各种设备尺寸的显示效果
- **SEO优化**：针对搜索引擎优化的网站结构和元数据
- **内容丰富**：包含各类修理相关资源，包括综合维修、汽车维修、电子产品维修等
- **统一体验**：所有语言版本提供相同的资源内容和分类结构
...
- 综合维修（General Repair）
- 汽车维修（Auto Repair）
- 电子产品维修（Electronics Repair）
- 家居与户外设备维修（Home & Outdoor）
- 维修权与配件平台（Right to Repair & Parts）
- 维修社区（Repair Communities）
- 维修技术资料与手册（Repair Manuals）
- 绿植与花园维护（Plant & Garden Care）

## 最新进展

- **2024-03-29**：完成了所有语言版本（德语、法语、西班牙语、日语和韩语）的资源统一，确保每个语言版本包含完整的8个分类和相应的资源链接。
- **2024-03-28**：实现了多语言页面的自动语言检测和重定向功能，优化了移动端显示效果。
- **2024-03-27**：完成了韩语版本的内容翻译和资源整理，与其他语言版本保持一致。
...
git remote add origin https://github.com/用户名/修理导航站.git
...
1. **独立HTML文件**：每种语言使用独立的HTML文件，存放在各自的语言目录下（如/en/, /cn/, /de/等）
2. **语言检测**：通过JavaScript检测用户浏览器语言设置，自动重定向到相应语言版本
3. **统一资源**：所有语言版本共享相同的资源链接，只有描述文本进行了翻译
4. **语言切换菜单**：在左侧导航栏提供直观的语言切换功能

## 关于模板

本项目基于[WebStack.cc](https://github.com/WebStackPage/WebStackPage.github.io)导航网站模板开发，特此感谢原作者的开源贡献。
